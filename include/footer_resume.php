<footer>
	<div class="width-inner">
		...
		<div class="footer-info-box">
			<div class="footer-info">상호 : 개인 포트폴리오</div>
			<div class="footer-info">대표자 : 김명식</div>
			<div class="footer-info">사업자등록 : 010-4996-1414</div>
			<div class="footer-info-spt"></div>
			<div class="footer-info">TEL : 010-4996-1414</div>
			<div class="footer-info">주소 : 서울특별시 도봉구 덕릉로 61길 32</div>
		</div>
